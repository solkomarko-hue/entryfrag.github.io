...
try {
  ...
  $scenarios = @(
    ...
    (Run-QaScenario -ViewportName 'phone-390x844' -Width 390 -Height 844 -Mobile $true -ScenarioDir (Join-Path $outputPath 'phone-390x844')),
    (Run-QaScenario -ViewportName 'phone-430x932' -Width 430 -Height 932 -Mobile $true -ScenarioDir (Join-Path $outputPath 'phone-430x932')),
    (Run-QaScenario -ViewportName 'tablet-768x1024' -Width 768 -Height 1024 -Mobile $true -ScenarioDir (Join-Path $outputPath 'tablet-768x1024')),
    (Run-QaScenario -ViewportName 'desktop-1440' -Width 1440 -Height 1400 -Mobile $false -ScenarioDir (Join-Path $outputPath 'desktop-1440'))
  )
